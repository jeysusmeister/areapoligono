...
public class Main {
    ...
    {
        JOptionPane.showMessageDialog(null, "Ud. selecciono el rectángulo", "Selecciono",JOptionPane.WARNING_MESSAGE);
        try{
    ...
    {
        JOptionPane.showMessageDialog(null, "Ud. selecciono el triángulo", "Selecciono",JOptionPane.WARNING_MESSAGE);
        try{
    ...
    public static void cuadrado(Area area){
        double areaC;
        JOptionPane.showMessageDialog(null, "Ud. selecciono el Cuadrado", "Selecciono",JOptionPane.WARNING_MESSAGE);
        try{
